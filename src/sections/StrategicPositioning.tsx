    ...
    <section className="py-32 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <span className="inline-block px-4 py-2 bg-[#CC0000]/10 border border-[#CC0000]/30 rounded-full text-[#CC0000] text-xs font-medium tracking-wider uppercase">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="px-8 py-4 bg-[#CC0000] text-white font-medium rounded-lg hover:bg-[#CC0000]/90 transition-all duration-300 shadow-lg shadow-[#CC0000]/25"
        >
          Explore Partnership
        </motion.button>
      </div>
